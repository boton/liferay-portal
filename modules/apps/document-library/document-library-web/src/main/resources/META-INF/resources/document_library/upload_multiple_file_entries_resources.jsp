...
<aui:form action="<%= uploadMultipleFileEntriesURL %>" method="post" name="fm2" cssClass="data-engine-avoid-submit" onSubmit='<%= "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "updateMultipleFiles();" %>'>
